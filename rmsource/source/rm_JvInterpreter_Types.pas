...
The Original Code is: rm_JvInterpreter_Types.PAS, released on 2002-07-04.
...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: rm_JvInterpreter_Types.pas 9350 2005-03-09 14:57:33Z marquardt $
...
const
  UnitVersioning: TUnitVersionInfo = (
    ...
    Date: '$Date: 2005-03-09 06:57:33 -0800 (Wed, 09 Mar 2005) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
