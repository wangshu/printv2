...
The Original Code is: rm_JvInterpreter_Db.PAS, released on 2002-07-04.
...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: rm_JvInterpreter_Db.pas 10317 2006-02-28 22:28:52Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile$';
    Revision: '$Revision: 10317 $';
    Date: '$Date: 2006-02-28 14:28:52 -0800 (Tue, 28 Feb 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
