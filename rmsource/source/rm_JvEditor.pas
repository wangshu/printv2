...
Known Issues:
  ...
  with [translated]
-----------------------------------------------------------------------------}
// $Id: JvEditor.pas 10449 2006-04-07 13:25:20Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile$';
    Revision: '$Revision: 10449 $';
    Date: '$Date: 2006-04-07 06:25:20 -0700 (Fri, 07 Apr 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
...
uses
  ...
  rm_JvUnicodeCanvas, rm_JvJCLUtils, rm_JvThemes, rm_JvConsts, rm_JvResources;
