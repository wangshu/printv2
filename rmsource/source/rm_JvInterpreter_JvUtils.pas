...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvInterpreter_JvUtils.pas 10078 2005-10-28 08:37:23Z marquardt $
...
uses
  ...
  FileCtrl,
  {$ENDIF COMPILER5}
  rm_JvJVCLUtils, rm_JvJCLUtils, rm_JvInterpreter_Windows;
...
{ (rom) disabled because the functions drag JvClxUtils.pas into rm_JvJCLUtils.pas
