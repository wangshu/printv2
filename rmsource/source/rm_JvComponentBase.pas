...
The Original Code is: rm_JvComponent.PAS, released on 2000-09-22.
...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: rm_JvComponentBase.pas 10172 2006-01-04 11:48:10Z ahuser $

unit rm_JvComponentBase;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile$';
    Revision: '$Revision: 10172 $';
    Date: '$Date: 2006-01-04 03:48:10 -0800 (Wed, 04 Jan 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
