...
The Original Code is: rm_JvJVCLUtils.PAS, released on 2002-09-24.
...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: rm_JvJVCLUtils.pas 10476 2006-04-13 14:06:45Z obones $
...
uses
  ...
  rm_JvVCL5Utils, rm_JvJCLUtils, {JvAppStorage,} rm_JvTypes;
