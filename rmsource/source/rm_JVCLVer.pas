...
The Original Code is: rm_JVCLVer.PAS, released on 2001-02-28.
...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: rm_JVCLVer.pas 10362 2006-03-11 09:23:42Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    ...
    Date: '$Date: 2006-03-11 01:23:42 -0800 (Sat, 11 Mar 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
