...
The Original Code is: rm_JvInterpreterFm.PAS, released on 2002-07-04.
...
Component   : form runner for rm_JvInterpreter

Known Issues:
-----------------------------------------------------------------------------}
// $Id: rm_JvInterpreterFm.pas 10346 2006-03-10 10:06:25Z ahuser $
...
{ history (JVCL Library versions):
  ...
  1.52:
   - fixed memory bug;
  1.52.4:
   - previous memory bug fix was moved to rm_JvInterpreter.pas unit;
  1.60:
...
uses
  ...
  rm_JvInterpreter, rm_JvJVCLUtils;
...
type
  ...
  public
    ...
    property rm_JvInterpreterFm: TJvInterpreterFm read FJvInterpreterFm write FJvInterpreterFm;
  end;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile$';
    Revision: '$Revision: 10346 $';
    Date: '$Date: 2006-03-10 02:06:25 -0800 (Fri, 10 Mar 2006) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
...
uses
  TypInfo,
  rm_JvResources, rm_JvTypes, rm_JvJCLUtils;
